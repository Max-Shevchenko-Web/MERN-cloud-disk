  ...
  if (fileView === 'list') {
    return (
        <div className='file' onClick={() => openDirHandler(file)}>
            ...
            {file.type !== 'dir' &&
            <button onClick={(e) => downloadClickHandler(e)} className="file__btn file__download"></button>}
            <button onClick={(e) => deleteClickHandler(e)} className="file__btn file__delete"></button>
        </div>
    );
  }
